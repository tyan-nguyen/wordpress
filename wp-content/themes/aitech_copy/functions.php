...
function aitech_scripts() {
	wp_enqueue_style( 'aitech-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'aitech-style', 'rtl', 'replace' );

	wp_enqueue_script( 'aitech-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
